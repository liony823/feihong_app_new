...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,rsaPublicKey,version,superToken,superTokenOn,welcomeMessage,newUserJoinSystemGroup,searchByPhone,registerInviteOn,sendWelcomeMessageOn,inviteSystemAccountJoinGroupOn,registerUserMustCompleteInfoOn,channelPinnedMessageMaxCount,canModifyApiUrl,shortnoEditOff,revokeSecond,ipWhiteList,loginType,sensitiveWords,disableChangeDevice,signupDeviceLimit,sigleIpRegisterLimitIn12hour,autoClearHistoryMsg,miniProgramVisible,discoveryVisible,chargeAndPayoutVisible,voiceCallVisible,videoCallVisible,signinAuthCodeVisible,friendOnlineStatusVisible,mobileMsgReadStatusVisible,signRedEnvelopeVisible,mineWalletVisible,walletPayoutMin,redEnvelopeVisible,transferVisible,transferMinAmount,mobileEditMsg,groupMemberSeeMember,msgTimeVisible,pinnedConversationSync,onlyInternalFriendAdd,onlyInternalFriendCreateGroup,onlyInternalFriendSendGroupRedEnvelope,onlyInternalFriendSendGroupCard,onlyInternalFriendGroupRobotFreeMsg,groupMemberLimit,userAgreementContent,privacyPolicyContent,momentsVisible]);
...
@useResult
$Res call({
 String rsaPublicKey, int version, String superToken, int superTokenOn, String welcomeMessage, int newUserJoinSystemGroup, int searchByPhone, int registerInviteOn, int sendWelcomeMessageOn, int inviteSystemAccountJoinGroupOn, int registerUserMustCompleteInfoOn, int channelPinnedMessageMaxCount, int canModifyApiUrl, int shortnoEditOff, int revokeSecond, String ipWhiteList, int loginType, String sensitiveWords, int disableChangeDevice, int signupDeviceLimit, int sigleIpRegisterLimitIn12hour, int autoClearHistoryMsg, int miniProgramVisible, int discoveryVisible, int chargeAndPayoutVisible, int voiceCallVisible, int videoCallVisible, int signinAuthCodeVisible, int friendOnlineStatusVisible, int mobileMsgReadStatusVisible, int signRedEnvelopeVisible, int mineWalletVisible, int walletPayoutMin, int redEnvelopeVisible, int transferVisible, int transferMinAmount, int mobileEditMsg, int groupMemberSeeMember, int msgTimeVisible, int pinnedConversationSync, int onlyInternalFriendAdd, int onlyInternalFriendCreateGroup, int onlyInternalFriendSendGroupRedEnvelope, int onlyInternalFriendSendGroupCard, int onlyInternalFriendGroupRobotFreeMsg, int groupMemberLimit, String userAgreementContent, String privacyPolicyContent, int momentsVisible
});
...
class _AppConfig implements AppConfig {
  const _AppConfig({required this.rsaPublicKey, required this.version, required this.superToken, required this.superTokenOn, required this.welcomeMessage, required this.newUserJoinSystemGroup, required this.searchByPhone, required this.registerInviteOn, required this.sendWelcomeMessageOn, required this.inviteSystemAccountJoinGroupOn, required this.registerUserMustCompleteInfoOn, required this.channelPinnedMessageMaxCount, required this.canModifyApiUrl, required this.shortnoEditOff, required this.revokeSecond, required this.ipWhiteList, required this.loginType, required this.sensitiveWords, required this.disableChangeDevice, required this.signupDeviceLimit, required this.sigleIpRegisterLimitIn12hour, required this.autoClearHistoryMsg, required this.miniProgramVisible, required this.discoveryVisible, required this.chargeAndPayoutVisible, required this.voiceCallVisible, required this.videoCallVisible, required this.signinAuthCodeVisible, required this.friendOnlineStatusVisible, required this.mobileMsgReadStatusVisible, required this.signRedEnvelopeVisible, required this.mineWalletVisible, required this.walletPayoutMin, required this.redEnvelopeVisible, required this.transferVisible, required this.transferMinAmount, required this.mobileEditMsg, required this.groupMemberSeeMember, required this.msgTimeVisible, required this.pinnedConversationSync, required this.onlyInternalFriendAdd, required this.onlyInternalFriendCreateGroup, required this.onlyInternalFriendSendGroupRedEnvelope, required this.onlyInternalFriendSendGroupCard, required this.onlyInternalFriendGroupRobotFreeMsg, required this.groupMemberLimit, required this.userAgreementContent, required this.privacyPolicyContent, required this.momentsVisible});
  factory _AppConfig.fromJson(Map<String, dynamic> json) => _$AppConfigFromJson(json);

@override final  String rsaPublicKey;
// 公钥
@override final  int version;
// 版本
@override final  String superToken;
// 超级token
@override final  int superTokenOn;
// 超级token是否开启
@override final  String welcomeMessage;
// 登录欢迎语
@override final  int newUserJoinSystemGroup;
// 新用户是否加入系统群聊
@override final  int searchByPhone;
// 是否可通过手机号搜索
@override final  int registerInviteOn;
// 是否开启注册邀请
@override final  int sendWelcomeMessageOn;
// 是否发送登录欢迎语
@override final  int inviteSystemAccountJoinGroupOn;
// 是否允许邀请系统账号进入群聊
@override final  int registerUserMustCompleteInfoOn;
// 是否要求注册用户必须填写完整信息
@override final  int channelPinnedMessageMaxCount;
// 频道置顶消息最大数量
@override final  int canModifyApiUrl;
// 是否可以修改API地址
@override final  int shortnoEditOff;
// 是否关闭短编号编辑
@override final  int revokeSecond;
// 消息可撤回时长
@override final  String ipWhiteList;
// 后台IP白名单
@override final  int loginType;
// app登录类型
@override final  String sensitiveWords;
// 敏感词
@override final  int disableChangeDevice;
// 是否禁止更换设备
@override final  int signupDeviceLimit;
// 设备限制注册限制数
@override final  int sigleIpRegisterLimitIn12hour;
// 单IP12小时注册限制数
@override final  int autoClearHistoryMsg;
// 自动清除几天前历史消息
@override final  int miniProgramVisible;
// 小程序页是否可见
@override final  int discoveryVisible;
// 发现页是否可见
@override final  int chargeAndPayoutVisible;
// 充值和提现是否可见
@override final  int voiceCallVisible;
// 语音通话是否可见
@override final  int videoCallVisible;
// 视频通话是否可见
@override final  int signinAuthCodeVisible;
// 登录授权码是否可见
@override final  int friendOnlineStatusVisible;
// 好友在线状态是否可见
@override final  int mobileMsgReadStatusVisible;
// 手机消息已读状态是否可见
@override final  int signRedEnvelopeVisible;
// 签到红包模块是否开启
@override final  int mineWalletVisible;
// 我的钱包是否开启
@override final  int walletPayoutMin;
// 钱包提现最小金额
@override final  int redEnvelopeVisible;
// 红包模块是否开启
@override final  int transferVisible;
// 转账模块是否开启
@override final  int transferMinAmount;
// 转账最小金额
@override final  int mobileEditMsg;
// 手机端是否可以编辑消息
@override final  int groupMemberSeeMember;
// 普通群成员是否可以查看其他群成员
@override final  int msgTimeVisible;
// 消息时间是否可见
@override final  int pinnedConversationSync;
// 置顶会话是否同步
@override final  int onlyInternalFriendAdd;
// 仅内部号可被加好友及加非内部号好友
@override final  int onlyInternalFriendCreateGroup;
// 仅内部号可建群
@override final  int onlyInternalFriendSendGroupRedEnvelope;
// 仅内部号可发群红包
@override final  int onlyInternalFriendSendGroupCard;
// 仅内部号可群内推送名片
@override final  int onlyInternalFriendGroupRobotFreeMsg;
// 群机器人免消息
@override final  int groupMemberLimit;
// 群人数限制
@override final  String userAgreementContent;
// 用户协议内容
@override final  String privacyPolicyContent;
// 隐私政策内容
@override final  int momentsVisible;
