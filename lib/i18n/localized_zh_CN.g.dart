...
class LocalizedAgreementZhCn {
	...
	TextSpan agreement({required InlineSpan userAgreement, required InlineSpan privacyPolicy}) => TextSpan(children: [
...
extension on Localized {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'agreement.agreement': return ({required InlineSpan userAgreement, required InlineSpan privacyPolicy}) => TextSpan(children: [
				const TextSpan(text: '我已阅读并同意 '),
				userAgreement,
				const TextSpan(text: ' 和 '),
				privacyPolicy,
