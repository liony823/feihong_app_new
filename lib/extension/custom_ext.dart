...
extension StrExt on String {
  ...
  CupertinoButtonView toUnderlineTextButton({required VoidCallback onPressed}) {
  ...
  CupertinoButtonView toTextButton({required VoidCallback onPressed}) {
    return CupertinoButtonView(
      onPressed: onPressed,
      child: Text(this)
          .fontSize(14.sp)
...
class SvgView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SvgPicture.asset(
      ...
      theme:
          SvgTheme(fontSize: 16.sp, currentColor: color ?? Styles.primaryDark),
    );
  }
}
