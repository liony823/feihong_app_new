...
import 'package:feihong/controller/auth/set_self_security_provider.dart';
...
@RoutePage()
class SetSelfSecurityPage extends HookConsumerWidget {
  const SetSelfSecurityPage({super.key});
  @override
