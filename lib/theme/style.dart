...
class Styles {
  ...
  // 输入框状态 - Input States
  static const inputBorderDefault = neutral300; // 默认边框
  static const inputBorderHover = neutral400; // 悬停边框
  static const inputBorderFocus = primaryDark; // 焦点边框
  static const inputBorderError = error; // 错误边框
  static const inputBorderDisabled = neutral200; // 禁用边框
  static const inputBgDisabled = neutral100; // 禁用背景

  // fill按钮状态 - Fill Button States
  static const fillButtonDefaultBg = brandColor; // 默认
  static const fillButtonDefaultSide = primaryDark; // 默认
  static const fillButtonPressedBg = primaryDark; // 按下
  static const fillButtonPressedSide = primaryDark; // 按下
  ...
  // 分割线 - Divider
  static const dividerColor = neutral200;
