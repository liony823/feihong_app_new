...
typedef StreamChannelListViewIndexedWidgetBuilder
    = StreamScrollViewIndexedWidgetBuilder<ChannelState, ChannelListTile>;

/// A [ListView] that shows a list of [WKUIConversationMsg]s,
...
class StreamChannelListView extends StatelessWidget {
  ...
  final void Function(ChannelState)? onChannelTap;

  /// Called when the user long-presses on this list tile.
  final void Function(ChannelState)? onChannelLongPress;
  ...
  Widget build(BuildContext context) {
            ...
            Center(
              child: Padding(
                ...
                child: StreamScrollViewEmptyWidget(
                  ...
                  emptyTitle: Text(
                    context.t.c.letsStartChattingLabel,
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final streamChannelListTile = ChannelListTile(
