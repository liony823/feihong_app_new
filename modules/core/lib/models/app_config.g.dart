...
_AppConfig _$AppConfigFromJson(Map<String, dynamic> json) => _AppConfig(
      ...
      newUserJoinSystemGroup:
          (json['new_user_join_system_group'] as num).toInt(),
      ...
      chargeAndPayoutVisible:
          (json['charge_and_payout_visible'] as num).toInt(),
      ...
      signRedEnvelopeVisible:
          (json['sign_red_envelope_visible'] as num).toInt(),
...
Map<String, dynamic> _$AppConfigToJson(_AppConfig instance) =>
    <String, dynamic>{
      ...
      'only_internal_friend_create_group':
          instance.onlyInternalFriendCreateGroup,
