...
@RoutePage()
class SetNicknameScreen extends HookConsumerWidget {
  final String nickname;
  const SetNicknameScreen({super.key, required this.nickname});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final ctrlController = useTextEditingController();
    final hasText = useState(false);
    final controller =
        ref.read(setNicknameControllerProvider(nickname: nickname).notifier);
    final state = ref.watch(setNicknameControllerProvider(nickname: nickname));
    ...
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 40.w,
        title: context.t.c.profile.nickname.appBarText,
        leadingWidth: 108.w,
        leading: Padding(
          ...
          Container(
            ...
            child: FilledButton(
              ...
              onPressed: hasText.value
                  ? () {
                      controller.submit(ctrlController.text);
                    }
                  : null,
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: state.nickname.isEmpty
                      ? context.t.c.profile.plsEnterNickname
                      : state.nickname,
